    ...
    function Optimize-Services-Extreme {
        try {
            $servicesToDisable = @(
                ...
                'AxInstSV', 'BDESVC', 'BTAGService', 'BthAvctpSvc', 'BthHFSrv',
                'bthserv', 'CertPropSvc', 'DcpSvc', 'DevQueryBroker', 'DeviceInstall',
                ...
                'WebClient', 'Wecsvc', 'WerSvc', 'WinHttpAutoProxySvc', 'WinRM',
                'camsvc', 'cloudidsvc', 'dcsvc', 'defragsvc',
                'diagnosticshub.standardcollector.service', 'diagsvc', 'dot3svc',
                'embeddedmode', 'fdPHost', 'lltdsvc', 'lmhosts', 'p2pimsvc',
                'p2psvc', 'perceptionsimulation', 'pla', 'seclogon', 'smphost',
                'spectrum', 'sppsvc', 'ssh-agent', 'svsvc', 'swprv', 'uhssvc',
                'upnphost', 'vds', 'vmicguestinterface', 'vmicheartbeat',
                'vmickvpexchange', 'vmicrdv', 'vmicshutdown', 'vmictimesync',
                'vmicvmsession', 'vmicvss', 'AJRouter', 'FontCache', 'Themes'
            )

            $servicesToManual = @(
                'BITS', 'wuauserv', 'DoSvc', 'UsoSvc', 'Schedule',
                'TrustedInstaller', 'AudioEndpointBuilder', 'Audiosrv', 'CDPSvc',
                'CDPUserSvc', 'CoreMessagingRegistrar', 'StateRepository',
                'UserManager', 'VaultSvc', 'Winmgmt', 'Wcmsvc', 'nsi', 'iphlpsvc',
                'Dnscache', 'Dhcp', 'EventLog', 'EventSystem', 'gpsvc', 'ProfSvc',
                'Power', 'DcomLaunch', 'RpcSs', 'RpcEptMapper', 'SamSs',
                'LanmanServer', 'LanmanWorkstation', 'PlugPlay', 'SENS',
                'ShellHWDetection', 'TrkWks', 'tiledatamodelsvc', 'BrokerInfrastructure',
                'SystemEventsBroker', 'CryptSvc', 'DPS', 'MpsSvc', 'mpssvc', 'BFE',
                'KeyIso', 'Netlogon', 'NlaSvc', 'PolicyAgent', 'SgrmBroker',
