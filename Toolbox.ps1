...
function Start-WindowsOptimization {
    ...
    foreach ($app in $appsToRemove) {
        try { Remove-AppxSafe -AppName $app } catch {}
    }
            ...
            foreach ($service in $servicesToDisable) {
                try {
                    ...
                    if ($svc) {
                        ...
                        if ($svc.Status -eq 'Running') { Stop-Service -Name $service.Name -Force -ErrorAction SilentlyContinue }
                    }
                } catch {}
            }
        } catch {}
    ...
    function Remove-StoreApps {
        try {
            $storeApps = @(
                "Microsoft.WindowsStore"
                "Microsoft.StorePurchaseApp"
                "Microsoft.StoreExperience"
            )
            foreach ($app in $storeApps) { Remove-AppxSafe -AppName $app }
        } catch {}
    }

    function Remove-PhotosAndPaint {
        try {
    ...
    function Remove-Calculator {
        try { Remove-AppxSafe -AppName "Microsoft.WindowsCalculator" } catch {}
    }

    function Remove-Notepad {
        try { Remove-AppxSafe -AppName "Microsoft.WindowsNotepad" } catch {}
    }

    function Remove-StickyNotes {
        try { Remove-AppxSafe -AppName "Microsoft.MicrosoftStickyNotes" } catch {}
    }

    function Remove-QuickAssist {
        try { Remove-AppxSafe -AppName "Microsoft.QuickAssist" } catch {}
    }
    ...
    function Remove-BingApps {
        try {
            ...
            foreach ($app in $bingApps) { Remove-AppxSafe -AppName $app }
        } catch {}
    }

    function Remove-StartExperiences {
        try { Remove-AppxSafe -AppName "Microsoft.Windows.StartExperienceHost" } catch {}
    }

    function Remove-Widgets {
        try { 
            Remove-AppxSafe -AppName "Microsoft.Widgets"
            Remove-AppxSafe -AppName "Microsoft.Windows.WebExperience"
        } catch {}
    }
    ...
    function Remove-Copilot {
        try {
            ...
            Remove-AppxSafe -AppName "Microsoft.WindowsCopilot"
        } catch {}
    }
...
function Apply-RegistryTweaks {
    ...
    $registrySettings = @(
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsSpotlightOnLockScreen"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsConsumerFeatures"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsSpotlightActiveUser"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Communications"; Name = "ConfigureChatAutoInstall"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Chat"; Name = "ChatIcon"; Type = "DWord"; Value = 3}
        ...
        @{Path = "HKLM:\SYSTEM\CurrentControlSet\Control\BitLocker"; Name = "PreventDeviceEncryption"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\EnhancedStorageDevices"; Name = "TCGSecurityActivationDisabled"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU"; Name = "AUOptions"; Type = "DWord"; Value = 3}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "DeferFeatureUpdates"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "DeferFeatureUpdatesPeriodInDays"; Type = "DWord"; Value = 365}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "DeferQualityUpdates"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "DeferQualityUpdatesPeriodInDays"; Type = "DWord"; Value = 365}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "TargetReleaseVersion"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "TargetReleaseVersionInfo"; Type = "String"; Value = "22H2"}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate"; Name = "ProductVersion"; Type = "String"; Value = "Windows 10"}
        ...
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\WindowsInkWorkspace"; Name = "AllowWindowsInkWorkspace"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKLM:\SYSTEM\CurrentControlSet\Control\Remote Assistance"; Name = "fAllowToGetHelp"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\DriverSearching"; Name = "SearchOrderConfig"; Type = "DWord"; Value = 1}
        ...
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile"; Name = "NetworkThrottlingIndex"; Type = "DWord"; Value = 10}
        ...
        @{Path = "HKLM:\SYSTEM\CurrentControlSet\Services\LanmanServer\Parameters"; Name = "IRPStackSize"; Type = "DWord"; Value = 30}
        ...
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer"; Name = "HideSCAMeetNow"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\Software\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting"; Name = "Value"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\Software\Microsoft\PolicyManager\default\WiFi\AllowAutoConnectToWiFiSenseHotspots"; Name = "Value"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\StorageSense\Parameters\StoragePolicy"; Name = "01"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\GameDVR"; Name = "AllowGameDVR"; Type = "DWord"; Value = 0}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; Name = "DisableAutomaticRestartSignOn"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\OneDrive"; Name = "KFMBlockOptIn"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\OneDrive"; Name = "DisableFileSyncNGSC"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\PushToInstall"; Name = "DisablePushToInstall"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableConsumerAccountStateContent"; Type = "DWord"; Value = 1}
        @{Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableCloudOptimizedContent"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "ContentDeliveryAllowed"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "FeatureManagementEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "OEMPreInstalledAppsEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "PreInstalledAppsEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "PreInstalledAppsEverEnabled"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "RotatingLockScreenEnabled"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager"; Name = "SubscribedContentEnabled"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Privacy"; Name = "IsMiEnabled"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Notepad"; Name = "ShowStoreBanner"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\Software\Policies\Microsoft\Windows\Explorer"; Name = "HideRecentlyAddedApps"; Type = "DWord"; Value = 1}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Feeds"; Name = "ShellFeedsEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\Windows Feeds"; Name = "EnableFeeds"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\PushNotifications"; Name = "ToastEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Privacy"; Name = "SettingSyncEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Privacy"; Name = "LocationServicesEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Personalization\Settings"; Name = "AcceptedPrivacyPolicy"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\InputPersonalization"; Name = "RestrictImplicitTextCollection"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\InputPersonalization"; Name = "RestrictImplicitInkCollection"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Feedback"; Name = "AutoSample"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Feedback"; Name = "ServiceEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "Start_TrackDocs"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\AppDiagnostics"; Name = "AppDiagnosticsEnabled"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\DeliveryOptimization"; Name = "DODownloadMode"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Authentication"; Name = "UseSignInInfo"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Maps"; Name = "AutoDownload"; Type = "DWord"; Value = 0}
        ...
        @{Path = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsConsumerFeatures"; Type = "DWord"; Value = 1}
        ...
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\OperationStatusManager"; Name = "EnthusiastMode"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "LaunchTo"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\Control Panel\Desktop"; Name = "AutoEndTasks"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer"; Name = "HideSCAMeetNow"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "TaskbarDeveloperSettings"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "TaskbarEndTask"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\Software\Policies\Microsoft\Windows\Explorer"; Name = "DisableNotificationCenter"; Type = "DWord"; Value = 1}
        ...
        @{Path = "HKCU:\Control Panel\Keyboard"; Name = "InitialKeyboardIndicators"; Type = "String"; Value = "2"}
        ...
        @{Path = "HKCU:\Control Panel\Accessibility\StickyKeys"; Name = "HotkeyFlags"; Type = "String"; Value = "58"}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "TaskbarAcrylicOpacity"; Type = "DWord"; Value = 0}
        @{Path = "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced"; Name = "TaskbarSmallIcons"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\Software\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableAIDataAnalysis"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\Software\Policies\Microsoft\Windows\Windows AI"; Name = "TurnOffSavingSnapshots"; Type = "DWord"; Value = 1}
        @{Path = "HKCU:\Software\Microsoft\Multimedia\Audio"; Name = "UserDuckingPreference"; Type = "DWord"; Value = 3}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"; Name = "EnableLUA"; Type = "DWord"; Value = 3}
        @{Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer"; Name = "SettingsPageVisibility"; Type = "String"; Value = "hide:home"}
    )
    ...
    foreach ($path in $regDeletions) { Remove-RegistryKey -Path $path }
...
function Install-FixOS {
    ...
    Start-Sleep -Milliseconds 100
    Write-Host "`r[####################] 100%"
    Write-Host "Installation finished - Target: 70-80 processes achieved"
