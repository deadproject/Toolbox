...
function Apply-RegistryTweaks70 {
...
function Install-FixOS {
    ...
    Start-Sleep -Milliseconds 100
    $registryResult = Apply-RegistryTweaks70
    ...
    Write-Host "`r[####################] 100%"
    Write-Host "Installation finished - Target: ~70 processes achieved"
